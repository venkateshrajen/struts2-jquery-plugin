...
ctx.beginPath();if(angle!=Math.PI*2)
...
if(!item)
return;highlight(item.series,eventname);var pos={pageX:e.pageX,pageY:e.pageY};target.trigger(eventname,[pos,item]);}
...
{if(series.angle<0)return;octx.fillStyle="rgba(255, 255, 255, "+options.series.pie.highlight.opacity+")";octx.beginPath();if(series.angle!=Math.PI*2)

	...
	(function($){
		...
		$.fn.extend({
			 ...
			 * 
			 * originalEvent may be passed in a reference to an event which triggered this publishing. This will be passed as the 
			 * 'originalEvent' field of the trigerred event which will allow for controlling the propagation of higher level events
			 * from with the topic handler.
			 */
				...
				if(originalEvent) {
					...
					$.extend(event,{
						...
						stopPropagation: function(){
							this.isImmediatePropagationStopped = originalEvent.isImmediatePropagationStopped = function returnTrue(){
								return true;
							};

...
public class Submit extends org.apache.struts2.components.Submit implements JQueryBean {
	...
	@StrutsTagAttribute(description="A comma separated list of ajax-enable ids of elements to realod with the contents of this request", type="String", defaultValue="", required=true)
	public void setTargets(String targets) {
		this.targets = targets;
	}

	@StrutsTagAttribute(description="Form id for which to serialize all fields during submission for load", type="String", defaultValue="")
